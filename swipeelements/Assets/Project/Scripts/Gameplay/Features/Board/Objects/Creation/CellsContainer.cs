...
namespace Project.Gameplay
{
    ...
    public class CellsContainer : ItemContainer<CellObject>
    {
        ...
        // void IAnySpawnListener.OnAnySpawn(GameEntity entity, CellType cellType)
        // {
        //     var cellObject = Spawn(new MergesCell(cellType), entity.coord.value);
        //     cellObject.Link(entity);
        // }

        protected override async UniTask DestroyRemoveAsync(Coord coord, CellObject item, CancellationToken cancellationToken)
        {
            try
            {
        ...
        public override CellObject Spawn(MergesCell cell, Coord coord)
        {
            var cellObject = base.Spawn(cell, coord);
            return cellObject;
        }

        protected override CellObject CreateItem(MergesCell cell, Coord coord)
        {
        ...
        public void Swap(Coord coord1, Coord coord2)
        {
        ...
        public Vector3 GetCellPosition(Coord coord) => _boardSettings.GetCellPosition(coord);

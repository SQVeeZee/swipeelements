...
public sealed class RemovePointerDownInputSystem : ICleanupSystem {

    readonly IGroup<InputEntity> _group;
    readonly List<InputEntity> _buffer = new List<InputEntity>();

    public RemovePointerDownInputSystem(Contexts contexts) {
        _group = contexts.input.GetGroup(InputMatcher.PointerDown);
    }

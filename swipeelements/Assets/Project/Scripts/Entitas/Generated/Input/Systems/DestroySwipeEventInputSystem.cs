...
public sealed class DestroySwipeEventInputSystem : ICleanupSystem {

    readonly IGroup<InputEntity> _group;
    readonly List<InputEntity> _buffer = new List<InputEntity>();

    public DestroySwipeEventInputSystem(Contexts contexts) {
        _group = contexts.input.GetGroup(InputMatcher.SwipeEvent);
    }
